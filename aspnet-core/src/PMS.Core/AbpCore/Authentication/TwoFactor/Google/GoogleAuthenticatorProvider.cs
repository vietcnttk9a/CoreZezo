...
namespace PMS.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : PMSServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("PMS", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
