...
using MvvmHelpers;
using PMS.Authorization.Users.Profile;
using PMS.Authorization.Users.Profile.Dto;
using PMS.Commands;
using PMS.Core.Threading;
...
using PMS.UI.Assets;
using PMS.Views;
using DependencyResolver = PMS.Core.Dependency.DependencyResolver;
...
namespace PMS.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "PMS";
