...
using PMS.Authentication.TwoFactor.Google;
using PMS.Authorization.Users.Dto;
using PMS.Authorization.Users.Profile.Cache;
using PMS.Authorization.Users.Profile.Dto;
using PMS.Dto;
using PMS.Friendships;
using PMS.Gdpr;
using PMS.Identity;
using PMS.Security;
using PMS.Storage;
...
namespace PMS.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : PMSAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("PMS",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("PMS",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
