...
using PMS.Migrations.Seed;
using PMS.Migrations.Seed.Host;
...
namespace PMS.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : PMSAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<PMSDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(PMSConsts.ConnectionStringName).Value.ToString();
        }
