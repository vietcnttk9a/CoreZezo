...
using PMS.Auditing.Exporting;
using PMS.Authorization;
using PMS.Authorization.Users;
using PMS.Dto;
using EntityHistoryHelper = PMS.EntityHistory.EntityHistoryHelper;

namespace PMS.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : PMSAppServiceBase, IAuditLogAppService
    {
