...
using PMS.EntityFrameworkCore.Repositories;

namespace PMS.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : PMSRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<PMSDbContext> dbContextProvider)
