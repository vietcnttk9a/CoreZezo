...
namespace PMS.Web.Public.Startup
{
    [DependsOn(
        typeof(PMSWebCoreModule)
    )]
    public class PMSWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public PMSWebFrontEndModule(IHostingEnvironment env, PMSEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PMSWebFrontEndModule).GetAssembly());
        }
    }
}
