...
using PMS.Url;
using PMS.Web.Public.Startup;
using PMS.Web.Session;

namespace PMS.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : PMSViewComponent
    {
