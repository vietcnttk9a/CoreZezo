...
using PMS.Web.Authentication.TwoFactor;
...
namespace PMS.Web
{
    ...
    public class PMSWebCoreModule : AbpModule
    {
        ...
        public PMSWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(PMSWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
